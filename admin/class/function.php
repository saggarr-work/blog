<?php
    Class adminBlog{
        ...
        public function add_post($data){
            ...
            $query = "INSERT INTO post(post_title, post_content, post_img, post_ctg, post_author, post_date, post_comment_count, post_summary, post_tag, post_status) VALUES('$post_title', '$post_content', '$post_img', $post_category, 'Admin', now(), 3, '$post_summary', '$post_tag', '$post_status')";
        ...
        //post status onujayi front end a post dekhay. 1 mane published & 0 mane unpublished
